package com.doubleruis.baiduspeech.recog.listener;

import android.os.Handler;
import android.os.Message;
import android.util.Log;

import com.doubleruis.baiduspeech.recog.RecogResult;
...
public class MessageStatusRecogListener extends StatusRecogListener {
    ...
    private void sendMessage(String message, int what, boolean highlight) {
        ...
        if (needTime && what != STATUS_FINISHED && what !=STATUS_FINISHED_ERROR) {
